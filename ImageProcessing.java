...
public class ImageProcessing {
	...
	public static void main(String[] args) {
		...
		Color[][] blues = inverse(orig);
		Color[][] pixelly = blackWhite(orig);
		Color[][] grey = blackAndWhite(orig);
		
		utils.addImage(checker, "Checkers");
		utils.addImage(blues, "Inverse");
		utils.addImage(pixelly, "Black and White");
		utils.addImage(grey, "Grey Scale");
